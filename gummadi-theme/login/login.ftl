                    ...
                    <#assign link=properties.links?split(',')>
                        <#list properties.titles?split(',') as title>
                            <#assign i=title?index>
                                <a href='${properties.baseUrl}${link[i]}'>
                                    ${title}
                                </a>
                        </#list>
                </div>
...
<#if usernameEditDisabled??>mdc-text-field--disabled</#if>">
                                        ...
                                        <input required id="username" class="mdc-text-field__input ${properties.kcInputClass!}" name="username" value="${(login.username!'')}" type="text" autofocus autocomplete="off" <#if usernameEditDisabled??>disabled
                    </#if>>
        ...
        <div>
            <div class="${properties.kcFormOptionsWrapperClass!} col-xs-12">
                <#if realm.resetPasswordAllowed>
                    ...
                    <span class="forgot-pass"><a href="${url.loginResetCredentialsUrl}">
        ...
        <div>
            <div col-xs-12">
                <button class="sign-up mdc-button mdc-button--raised ${properties.kcButtonClass!} 
                    ${properties.kcButtonPrimaryClass!} ${properties.kcButtonLargeClass!}" formnovalidate
                    name="Create Account" id="signUp" onclick="window.location.href = '${msg("signUpUrl")}'">
                    ${msg("createAccount")}
                </button>
            </div>
        </div>
